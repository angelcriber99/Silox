...
export const revolutImportSuccessSchema = z.object({
  ...
  accountingMovements: z.number().int().nonnegative().optional(),
  ignoredAccountingMovements: z.number().int().nonnegative().optional(),
  updatedAccountingMovements: z.number().int().nonnegative().optional(),
