    ...
    <div className="min-h-screen bg-background selection:bg-orange-500/30">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-6 pb-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-0 divide-y md:divide-y-0 md:divide-x divide-border border-y border-border mb-10">
          <div className="p-6">
            <span className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground">Tokens</span>
            <p className="text-xl font-medium text-foreground tabular-nums mt-1">{position.unidades.toFixed(6)}</p>
          </div>
          <div className="p-6">
            <span className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground">Balance</span>
              ...
              <tbody className="divide-y divide-border">
                {txTableData.slice().reverse().map((tx) => (
                  <tr key={tx.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-4 py-4 text-right tabular-nums text-foreground">{Number(tx.cantidad).toFixed(6)}</td>
