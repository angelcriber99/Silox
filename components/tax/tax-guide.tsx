...
export function TaxGuide() {
  return (
    <div className="bg-card/40 border border-border rounded-xl p-6 backdrop-blur-sm space-y-6">
      <div className="flex items-center gap-3 border-b border-border pb-4">
        <Scale className="h-6 w-6 text-blue-400" />
        <h2 className="text-xl font-bold text-foreground">Guía Fiscal Básica (España)</h2>
      </div>
